...
import {setIsSettingOpen, setClientLogin, setIsAutoRune, setIsAutoSpell, setApril} from "../../redux/slices/common";
                ...
                <div className={"popup-settings-main"}>
                    ...
                    <>
                        ...
                        {aprilFoolsDay(2022) &&
                          <div className={"popup-settings-main-row"}>
                              <div style={{display: "flex", alignItems: "center"}}>
                                  <div className={"popup-settings-main-row-title"}>{t("settings.april")}</div>
                                  <label className="switch">
                                      <input type="checkbox" checked={gameSettings.april} onChange={onChangeApril}/>
                                      <span className="slider round"></span>
                                  </label>
                              </div>
                              <div className="popup-settings-main-row-desc">{t("settings.april-desc")}</div>
                          </div>
                        }
                    </>
                    }
